...
def params():
    ...
    parser.add_argument("--task", default="baseline", type=str,
                    help="baseline is fine-tuning bert for classification;\n"
                         "tune is advanced techniques to fine-tune bert;\n"
                         "contrast is contrastive learning method",
                    choices=['baseline', 'custom','tune', 'supcon', 'simcse'])
    ...
    parser.add_argument("--version-name", default="", type=str,
                help="Name of model, to differentiate between different hyperparam settings.")
